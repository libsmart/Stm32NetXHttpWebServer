...
#undef LIBSMART_STM32NETX_NETX_THREAD_STACK_SIZE
#define LIBSMART_STM32NETX_NETX_THREAD_STACK_SIZE (10*LIBSMART_STM32NETX_DEFAULT_MEMORY_SIZE)

#undef LIBSMART_STM32NETX_PACKET_POOL_SIZE
#define LIBSMART_STM32NETX_PACKET_POOL_SIZE ((LIBSMART_STM32NETX_PAYLOAD_SIZE + sizeof(NX_PACKET)) * 20)
