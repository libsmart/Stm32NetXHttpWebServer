...
#ifndef NUCLEO_F429ZI_WEBSERVER_APPCORE_DEFINES_H
#define NUCLEO_F429ZI_WEBSERVER_APPCORE_DEFINES_H

/** Name of the firmware. */
#define FIRMWARE_NAME "nucleo-f429zi Stm32NetXHttpWebServer example"
